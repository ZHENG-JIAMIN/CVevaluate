...
import sty from "./PlasmicNewPage2.module.css"; // plasmic-import: R4fPjHrExtsx/css
...
export type PlasmicNewPage2__ArgsType = {
  图片?: React.ComponentProps<typeof PlasmicImg__>["src"];
};
type ArgPropType = keyof PlasmicNewPage2__ArgsType;
export const PlasmicNewPage2__ArgProps = new Array<ArgPropType>("\u56fe\u7247");
  ...
  const args = React.useMemo(
    () =>
      Object.assign(
        {
          图片: {
            src: "/plasmic/c_vevaluate/images/组20118Png.png",
            fullWidth: 86,
            fullHeight: 86,
...
const PlasmicDescendants = {
  root: ["root", "sanityFetcher", "freeBox"],
  sanityFetcher: ["sanityFetcher", "freeBox"],
  freeBox: ["freeBox"]
} as const;
