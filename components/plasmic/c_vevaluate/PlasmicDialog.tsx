...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: U1HHI9SEh2Do/css
...
function PlasmicDialog__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_f5vM01qEys16"]]: true })}
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__rpai3)}
              >
                <div
                  className={classNames(
                    projectcss.all,
...
const PlasmicDescendants = {
  dialog: ["dialog", "dialogContent", "freeBox", "dialogTitle", "h5"],
  dialogContent: ["dialogContent", "freeBox", "dialogTitle", "h5"],
