...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: F1bm_Pa7o7bk/css
...
function PlasmicDrawer__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_9ZQehrW3RAbT"]]: true })}
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox___0C7Wk)}
              >
                <div
                  className={classNames(
                    projectcss.all,
...
const PlasmicDescendants = {
  dialog: ["dialog", "drawerContent", "freeBox", "dialogTitle"],
  drawerContent: ["drawerContent", "freeBox", "dialogTitle"],
