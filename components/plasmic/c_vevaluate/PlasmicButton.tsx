...
import sty from "./PlasmicButton.module.css"; // plasmic-import: O-sjQ-BfXg_q/css
...
export type PlasmicButton__VariantsArgs = {
  ...
  shape2?: SingleChoiceArg<"round" | "sharp">;
    ...
    <Stack__
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootshape2_round]: hasVariant($state, "shape2", "round"),
          [sty.rootshape2_round_size_compact]:
            hasVariant($state, "shape2", "round") &&
            hasVariant($state, "size", "compact"),
          [sty.rootshape2_sharp]: hasVariant($state, "shape2", "sharp"),
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__uv0Cj)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon2Icon
                className={classNames(projectcss.all, sty.svg__udGeh)}
                role={"img"}
              />
            ),
